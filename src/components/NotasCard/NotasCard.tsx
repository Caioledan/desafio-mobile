...
import { NotasCardProps } from "../../interfaces/components.interface";
      ...
      <View style={styles.notasContainer}>
        ...
        {isEditing ? (
          ...
          <Text style={styles.titleText}>
            {parcial.trim() !== "" ? parseFloat(parcial).toFixed(1) : "--"}
          </Text>
        )}
        ...
        {isEditing ? (
          ...
          <Text style={styles.titleText}>
            {bimestral.trim() !== "" ? parseFloat(bimestral).toFixed(1) : "--"}
          </Text>
        )}

        <Text style={styles.titleText}>{totalParaExibir}</Text>
        <Text style={[styles.titleText, estiloSituacao, { fontSize: 16 }]}>
          {situacao}
        </Text>
      </View>
    </View>
