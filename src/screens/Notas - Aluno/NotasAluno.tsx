...
export function NotasAluno() {
  ...
  const {isLoading, disciplina, professor, aluno, notas, user} = useNotas(disciplinaId)
  ...
  return (
    <View style={styles.container}>
        ...
        <DisciplinaInfo disciplina={disciplina} professor={professor} aluno={aluno}/>
        {user && notas ? (
          <NotasCard matricula={user.matricula} parcial={notas.parcial} bimestral={notas.bimestral} total={notas.total} situacao={notas.situacao}/> 
        ) : (
